...
public static function dynamic_js($block, $block_id) {
			...
			$photoboxfocus = parent::get_setting($block, 'hover-focus', 'True');
		...
		*/	
			...
			if ($photoboxfocus == true)	{
				...
				$js .= '
					...
					if ( currentClass === "gallery" ) {
					    addedClass = " hover-parent";
					}
					return addedClass;
					});
					...
					if ( currentClass === "gallery-img" ) {
					    addedClass = " hover-child";
					}
					return addedClass;
					});
